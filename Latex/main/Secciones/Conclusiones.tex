...
cumplido: se ha presentado el formalismo de Mie y de la matriz $T$ para la
dispersión por una y varias esferas (sección~\ref{sec:miecoeffs}), y se ha
analizado cómo el código MSTM de Mackowski implementa este formalismo y qué
...
El entorno gráfico en Python sobre MSTM constituye una de las principales 
