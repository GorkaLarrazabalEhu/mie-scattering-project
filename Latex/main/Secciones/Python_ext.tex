...
$\tilde{m}$ a la longitud de onda solicitada. 
% El espaciado
...
$\tilde{m}(\lambda)$ interpolado, manteniendo fija la geometría física del
...
y $\tilde{m}$ son constantes y se calculan una sola vez; lo único que
