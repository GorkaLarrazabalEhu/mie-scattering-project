...
\begin{figure}[H]
    ...
    \caption{Interfaz gráfica del entorno en Python para MSTM,
...
superficies $d$ que indica el usuario: la distancia centro a centro de un
par de esferas se fija como $D_{ij} = a_i + a_j + d$, de manera que el hueco
entre superficies es exactamente $d$ con independencia de los radios. Se
...
misma regla $D_{ij} = a_i + a_j + d$, de manera que la separación entre superficies
$d$ se mantiene constante mientras crece el radio. Esto permite estudiar
...
puntos a lo largo del hueco más estrecho entre dos esferas, $d_{\min}$.
