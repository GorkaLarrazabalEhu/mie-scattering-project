...
\begin{figure}[H]
  ...
  \caption{Campo cercano $|\mathbf{E}|^2$ de la esfera individual de Au para
           ...
           desplazada hacia delante (la cara de sombra), reflejo de la
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../../Simulaciones/Definitivo/simulacion-de-referencia/2e/ew/sep5/sw/plots/Eficiencias_-_Unpol.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../../Simulaciones/Definitivo/simulacion-de-referencia/2e/ew/sep5/wl730/plots/Figure_1_log.png}
