...
conecta con el formalismo desarrollado en la sección~\ref{sec:formalismo} y
...
la dirección $x$ —contenida en un plano de polarización—, de las dos
...
Harris \textit{et al.}~\cite{Harris2009} se calcularon con el código de la T-matrix de
Mackowski y Mishchenko, 
