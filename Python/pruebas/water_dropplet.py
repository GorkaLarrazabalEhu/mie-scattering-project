...
## according to de Bohren book, the cross section = the area of the surface of the particle (p.110 and p.72)
csca = qsca * np.pi*radius**2

plt.plot(lambda0 * 1000, csca)
